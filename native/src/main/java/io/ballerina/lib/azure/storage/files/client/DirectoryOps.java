...
public final class DirectoryOps {
    ...
    public static Object renameDirectory(Environment env, BObject self, BString sourcePath,
        ...
        return AzureClientInvoker.invoke(env, () -> {
            ...
            ShareDirectoryClient client = AzureClientInvoker.shareClient(self).getDirectoryClient(source);
    ...
    static ShareDirectoryClient directoryClient(BObject self, BString directoryPath) {
        String path = AzureClientInvoker.directoryPath(directoryPath);
        return path.isEmpty()
                ? AzureClientInvoker.shareClient(self).getRootDirectoryClient()
                : AzureClientInvoker.shareClient(self).getDirectoryClient(path);
    }
}
